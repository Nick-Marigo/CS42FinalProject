...
class Infantry extends Troop {
  constructor(scene, x, y) {
    super(scene, x, y, 'infantry', null, 100, 30, 50, 75, 50); //scene, pos x, pos y, string(texture), frame(null), Health, damage, cost, range, speed
  }
}

class enemy extends Troop {
  constructor(scene, x, y) {
    super(scene, x, y, 'enemy', null, 100, 30, 50, 75, -50);
